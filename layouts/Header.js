          ...
          <ul>
            ...
            <li className="has-dropdown">
              ...
              <ul className="submenu">
                <li>
                  <Link href="delivery">Delivery Pack</Link>
                </li>
              </ul>
            </li>
            <li>
          ...
          <div className="offcanvas__wrapper">
            <div className="offcanvas__content">
              ...
              <p className="text d-none d-xl-block mb-5">
                Trusted relocation services, with trained staff the for packing
                loading transport safe delivery across cities ensuring smooth
                moves. Our team handles every relocation responsibly.
              </p>
                  ...
                  <li className="d-flex align-items-center">
                    ...
                    <div className="offcanvas__contact-text">
                      <a target="_blank" href="#">
                        Mart  HSR  banglore karnataka(560102)
                      </a>
                    </div>
                  </li>
                  <li className="d-flex align-items-center">
...
const Header6 = ({ single }) => {
  ...
  const singleMenu = [
    ...
    { id: 4, href: "delivery", title: "delivery" },
  ];
  return (
    <Fragment>
